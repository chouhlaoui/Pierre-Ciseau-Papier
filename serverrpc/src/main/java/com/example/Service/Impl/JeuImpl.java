...
public class JeuImpl implements IJeu, Serializable {
    ...
    @Override
    public List<String> playRound(String clientId, String clientChoice) {
    ...
    @Override
    public String getGameResult(String clientId) {
        int clientScore = scoresClient.getOrDefault(clientId, 0);
